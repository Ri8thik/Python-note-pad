...
# so we take main_menu as a variable which store the data of menu

main_menu =tk.Menu()
# the folders which has been addeted in the menu(here we create 4 folders (file,view,edit,color_theme) )

############################### F_I_L_E_ ##############################################
#file icons (here we store the icons for the file folder)
...
#here File (folder) create
file = tk.Menu(main_menu,tearoff=False)

#commands
#now store the data in the folder such as new, open ,save , save_as ,exit
...
color_dict={
    ...
    'Dark':('#c4c4c4','#2d2d2d'),
    'Red':('#2d2d2d','#ffe8e8'),
    'Monokali':('#d3b774','#474747'),
    'Night Blue' :('#ededed','#6b9dc2')
}
# cascade(means it add the folders in the menu bar)
...
# here we create a scrool bar which is most helpfull
...
def change_fontsize(main_aplication):
...
file.add_command(label="Save As", image=save_as_icon , compound =tk.LEFT ,accelerator="Ctrl+w",command=save_as) 
...
main_application.bind("<Control-w>", save_as)
